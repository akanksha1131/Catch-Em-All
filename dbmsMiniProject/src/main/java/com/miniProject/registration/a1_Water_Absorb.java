...
/**
 * Servlet implementation class a1_Water_Absorb
 */
@WebServlet("/a1_Water_Absorb")
public class a1_Water_Absorb extends HttpServlet {
private static final long serialVersionUID = 1L;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	    ...
    	    try {
    	        ...
    	        updateStmt.setString(1, "Water Absorb");
