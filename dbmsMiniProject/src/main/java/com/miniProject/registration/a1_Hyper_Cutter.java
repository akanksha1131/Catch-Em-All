...
/**
 * Servlet implementation class a1_Hyper_Cutter
 */
@WebServlet("/a1_Hyper_Cutter")
public class a1_Hyper_Cutter extends HttpServlet {
private static final long serialVersionUID = 1L;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	    ...
    	    try {
    	        ...
    	        updateStmt.setString(1, "Hyper Cutter");
