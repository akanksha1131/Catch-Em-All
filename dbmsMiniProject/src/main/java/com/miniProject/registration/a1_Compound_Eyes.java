...
/**
 * Servlet implementation class a1_Compound_Eyes
 */
@WebServlet("/a1_Compound_Eyes")
public class a1_Compound_Eyes extends HttpServlet {
private static final long serialVersionUID = 1L;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	    ...
    	    try {
    	        ...
    	        updateStmt.setString(1, "Compound Eyes");
