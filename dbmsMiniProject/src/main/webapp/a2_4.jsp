			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						...
						<form method="post" action="a2_Effect_Spore" class="register-form"
							id="login-form">
						...
						<form method="post" action="a2_Filter" class="register-form"
							id="login-form">
							
						
							<div class="form-group form-button">
								<input type="submit" name="ability1" id="signin"
									class="form-submit" value="Filter" />
							</div>
						</form>
						
						<form method="post" action="a2_Flame_Body" class="register-form"
							id="login-form">
						...
						<form method="post" action="a2_Flash_Fire" class="register-form"
							id="login-form">
						...
						<form method="post" action="a2_5.jsp" class="register-form"
							id="login-form">
