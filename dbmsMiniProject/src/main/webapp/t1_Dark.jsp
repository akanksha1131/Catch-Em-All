			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						<h2 class="form-title">Is your Pokemon's primary Type "Dark"?</h2>
			
						<form method="post" action="t1_Dark" class="register-form"
							id="login-form">
						...
						<form method="post" action="t1_Dragon.jsp" class="register-form"
							id="login-form">
