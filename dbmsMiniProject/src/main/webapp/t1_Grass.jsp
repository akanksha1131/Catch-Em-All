			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						<h2 class="form-title">Is your Pokemon's primary Type "Grass"?</h2>
			
						<form method="post" action="t1_Grass" class="register-form"
							id="login-form">
						...
						<form method="post" action="t1_Electric.jsp" class="register-form"
							id="login-form">
