			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						<h2 class="form-title">Is your Pokemon's primary Type "Ice"?</h2>
			
						<form method="post" action="t1_Ice" class="register-form"
							id="login-form">
						...
						<form method="post" action="t1_Fighting.jsp" class="register-form"
							id="login-form">
